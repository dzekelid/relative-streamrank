...
- name: NPR
  ...
  tags: News, Radio, Getting Started Example, Federal Government, Stack Network, Stack,
    ...
    Data, Service API, Pedestal, Relative StreamRank, StreamRank
  properties:
...
- name: NPR
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/relative-streamrank/master/_listings/npr/openapi.md
x-common:
- type: x-api-gallery
